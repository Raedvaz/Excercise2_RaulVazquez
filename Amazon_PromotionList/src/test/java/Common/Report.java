...
public class Report {
    ...
    public static void fnSetupReport()
    {
        ...
        objSpark = new ExtentSparkReporter("C:\\Report\\Spark.html");
        objSpark.config(ExtentSparkReporterConfig.builder().theme(Theme.DARK).documentTitle("Selenium Report").build());
    ...
    private static String fnScreenshot()
    {
        ...
        try
        {
            ...
            File scrFile = ((TakesScreenshot)Browser.objDriver).getScreenshotAs(OutputType.FILE);
